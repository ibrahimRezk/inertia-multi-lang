            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('lang', [$page.props.locale, 'Dashboard'])" :active="
                                    route().current('lang', [$page.props.locale, 'Dashboard'])
                                ">
                ...
                <div :class="{
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        <JetResponsiveNavLink :href="route('lang', [$page.props.locale, 'Dashboard'])" :active="
                            route().current('lang', [$page.props.locale, 'Dashboard'])
                        ">
                            Dashboard
